...
-- 3. Оновити статус конкретного завдання (наприклад, змінити статус на 'in progress')
...
-- 8. Знайти користувачів з певною електронною поштою (наприклад, '%@example.com')
SELECT * FROM users WHERE email LIKE '%@example.com';

-- 9. Оновити ім'я користувача
UPDATE users SET fullname = 'Нове імʼя' WHERE id = 1;
...
-- 11. Отримати завдання, які призначені користувачам з певною доменною частиною електронної пошти (наприклад, '%@example.com')
SELECT tasks.* 
FROM tasks 
